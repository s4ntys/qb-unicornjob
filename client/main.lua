...
RegisterNetEvent('qb-unicornjob:v-shots-pack', function()
    QBCore.Functions.Progressbar('name_here', 'Otvorenie balenia panákov...', 2000, false, true, {
        ...
        QBCore.Functions.Notify('Otvorili ste balenie panákov!', 'primary', 7500)
...
RegisterNetEvent('qb-unicornjob:vodka-crate', function()
    QBCore.Functions.Progressbar('name_here', 'Otvorenie debny vodky...', 2000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        QBCore.Functions.Notify('Otvorili ste balenie vodky!', 'primary', 7500)
        ClearPedTasks(PlayerPedId())
    end)
end)
...
RegisterNetEvent('qb-unicornjob:whiskey-box', function()
    QBCore.Functions.Progressbar('name_here', 'Otvorenie škatule whisky...', 2000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        QBCore.Functions.Notify('Otvorili ste škatuľu whisky!', 'primary', 7500)
        ClearPedTasks(PlayerPedId())
    end)
end)
...
RegisterNetEvent('qb-unicornjob:beer-crate', function()
    QBCore.Functions.Progressbar('name_here', 'Otvorenie debny piva...', 2000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        QBCore.Functions.Notify('Otvorili ste debnu piva!', 'primary', 7500)
        ClearPedTasks(PlayerPedId())
    end)
end)
...
RegisterNetEvent('qb-unicornjob:tequila-crate', function()
    QBCore.Functions.Progressbar('name_here', 'Otvorenie debny tequily...', 2000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        QBCore.Functions.Notify('Otvorili ste debnu tequily!', 'primary', 7500)
        ClearPedTasks(PlayerPedId())
    end)
end)
...
RegisterNetEvent('qb-unicornjob:fruit-box', function()
    QBCore.Functions.Progressbar('name_here', 'Otvorenie krabice s ovocím...', 2000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        QBCore.Functions.Notify('Otvorili ste škatuľu s ovocím!', 'primary', 7500)
        ClearPedTasks(PlayerPedId())
    end)
end)
...
AddEventHandler("qb-unicornjob:MakeEspressoMartini", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-unicornjob:server:get:ingredientEspressoMartini', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Príprava espressa Martini..", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					disableMouse = false,
					disableCombat = true,
					...
					TriggerServerEvent('qb-unicornjob:server:espresso')
                    			...
                    			QBCore.Functions.Notify("Vyrobili ste Espresso Martini", "success")
				end, function()
					QBCore.Functions.Notify("TY KOKOT", "error")
				end)
			else
   				QBCore.Functions.Notify("Nemáte položky, aby ste to spravili", "error")
			end
		end)
	else 
		QBCore.Functions.Notify("Musíte byť prihlásený do práce", "error")
	end  
end)
...
AddEventHandler("qb-unicornjob:MakeMargarita", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-unicornjob:server:get:ingredientmargarita', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Výroba Margarity..", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					disableMouse = false,
					disableCombat = true,
					...
					TriggerServerEvent('qb-unicornjob:server:margaritatata')
                    			...
                    			QBCore.Functions.Notify("Vyrobili ste Margaritu", "success")
				end, function()
					QBCore.Functions.Notify("TY KOKOT", "error")
				end)
			else
   				QBCore.Functions.Notify("Nemáte ingrediencie na to, aby ste to urobili", "error")
			end
		end)
	else 
		QBCore.Functions.Notify("Musíte byť prihlásený do práce", "error")
...
AddEventHandler("qb-unicornjob:MakeManhattan", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-unicornjob:server:get:ingredientManhattan', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Tvorba Manhattanu.", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					disableMouse = false,
					disableCombat = true,
					...
					TriggerServerEvent('qb-unicornjob:server:manhattan')
                    			...
                    			QBCore.Functions.Notify("Vyrobili ste Manhattan", "success")
				end, function()
					QBCore.Functions.Notify("TY KOKOT !!!", "error")
				end)
			else
...
AddEventHandler("qb-unicornjob:MakeOldFashioned", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-unicornjob:server:get:ingredientOldFashioned', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Výroba staromódnych neviem čo", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					disableMouse = false,
					disableCombat = true,
					...
					TriggerServerEvent('qb-unicornjob:server:oldfash')
                    			...
                    			QBCore.Functions.Notify("Vyrobili ste Old Fashioned", "success")
				end, function()
					QBCore.Functions.Notify("TY KOKOT !!!", "error")
				end)
			else
...
AddEventHandler("qb-unicornjob:MakeSparkles", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-unicornjob:server:get:ingredientSparkles', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Výroba Sparkles..", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					disableMouse = false,
					disableCombat = true,
					...
					TriggerServerEvent('qb-unicornjob:server:sparkle')
                    			...
                    			QBCore.Functions.Notify("Vyrobili ste Sparkles", "success")
				end, function()
					QBCore.Functions.Notify("TY KOKOT !!!", "error")
				end)
			else
...
AddEventHandler("qb-unicornjob:MakeUnicorn", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-unicornjob:server:get:ingredientUnicorn', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Výroba jednorožca..", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					disableMouse = false,
					disableCombat = true,
					...
					TriggerServerEvent('qb-unicornjob:server:unicorndrink')
                    			...
                    			QBCore.Functions.Notify("Vytvorili ste jednorožca ako drinku hej !", "success")
				end, function()
					QBCore.Functions.Notify("TY KOKOT !!!", "error")
				end)
			else
...
AddEventHandler("qb-unicornjob:MakeDancerz", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-unicornjob:server:get:ingredientDancerz', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Tvorba Dancerz..", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					disableMouse = false,
					disableCombat = true,
					...
					TriggerServerEvent('qb-unicornjob:server:dancerzz')
                    			...
                    			QBCore.Functions.Notify("Vyrobili ste Dancerz", "success")
				end, function()
					QBCore.Functions.Notify("TY KOKOT !!!", "error")
				end)
			else
...
AddEventHandler("qb-unicornjob:MakeHulk", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-unicornjob:server:get:ingredientHulk', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Výroba Hulka..", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					disableMouse = false,
					disableCombat = true,
					...
					TriggerServerEvent('qb-unicornjob:server:hulkmake')
                    			...
                    			QBCore.Functions.Notify("Vytvorili ste Hulk", "success")
				end, function()
					QBCore.Functions.Notify("TY KOKOT !!!", "error")
				end)
			else
...
AddEventHandler("qb-unicornjob:MakeClass", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-unicornjob:server:get:ingredientClass', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Tvorba triedy..", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					disableMouse = false,
					disableCombat = true,
					...
					TriggerServerEvent('qb-unicornjob:server:unicorndrink')
                    			...
                    			QBCore.Functions.Notify("Vytvorili ste triedu ako alkohol ! ", "success")
				end, function()
					QBCore.Functions.Notify("TY KOKOT !!!", "error")
				end)
			else
