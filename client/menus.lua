                ...
                options = {
                    {
                        ...
                        icon = "fas fa-laptop",
                        label = "Objednajte si ingrediencie!",
                        job = "vunicorn",
                    },
                },
                distance = 1.5
...
RegisterNetEvent('qb-menu:OrderMenu', function(data)
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            header = "• Položky objednávky",
            txt = "Objednajte si nové ingrediencie!",
            params = {
        ...
        },
        {
            ...
            header = "• Otvorit chladničku",
            txt = "Pozrite sa, čo máte v sklade",
            params = {
